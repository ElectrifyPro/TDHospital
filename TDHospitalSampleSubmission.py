...
class Solution:
    ...
    def calculate_death_prob(self, timeknown, cost, reflex, sex, blood, bloodchem1, bloodchem2, temperature, race,
        ...
        """
        labels = ['reflex', 'blood', 'bloodchem1', 'bloodchem2', 'temperature', 'heart', 'psych1', 'glucose', 'psych2', 'dose', 'bloodchem3', 'confidence', 'bloodchem4', 'comorbidity', 'age']
        values = [float(x) for x in [blood, reflex, bloodchem1, bloodchem2, temperature, heart, psych1, glucose, psych2, dose, bloodchem3, confidence, bloodchem4, comorbidity, age]]
        df = dict()
